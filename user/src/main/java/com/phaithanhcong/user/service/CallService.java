...
public class CallService {
    ...
    public CallLog startCall(Long callerId, Long calleeId, String callType) {
    ...
    public boolean markStarted(Long callLogId) {
        if (callLogId == null) {
            return false;
        }
    ...
    public boolean endCall(Long callLogId, String statusCode) {
    ...
    public Map<String, Object> handleSignal(Map<String, Object> message) {
        ...
        switch (type) {
            case "OFFER" -> {
                CallLog callLog = startCall(fromUserId, toUserId, callType);
                callLogId = callLog != null ? callLog.getId() : null;
            }
            case "ANSWER" -> markStarted(callLogId);
            case "CALL_REJECT" -> endCall(callLogId, "REJECTED");
            case "CALL_END" -> endCall(callLogId, "COMPLETED");
            default -> {
    ...
    public void processSignal(Map<String, Object> message) {
